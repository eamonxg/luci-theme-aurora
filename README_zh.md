...
- **可切换导航**：可在 Aurora 顶部导航和 Atom 风格侧边栏布局之间切换。
- **高度可定制**：[luci-app-aurora-config](https://github.com/eamonxg/luci-app-aurora-config) 插件内置多套主题预设，可自由切换；同时还支持自定义颜色、导航布局、导航子菜单样式和主题 Logo 资源。
